...
def test_customer_login(driver):
    ...
    # Shipment.click()
    time.sleep(2)
    dropdown = driver.find_element(By.CLASS_NAME, "mat-select-arrow ng-tns-c70-734")
    movetodropdown = ActionChains(driver)
    movetodropdown.move_to_element(dropdown).click().perform()
    elementsindropdown = driver.find_elements(By.CLASS_NAME, "mat-option-text")
